...
@shared_task(name="animal_worker.update_animal_state")
...
@shared_task(name="animal_worker.process_all_animals")
...
@shared_task(name="animal_worker.migrate_animals")
...
@shared_task(name="animal_worker.spawn_animals")
